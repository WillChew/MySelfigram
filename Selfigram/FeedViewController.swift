...
class FeedViewController: UITableViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://www.flickr.com/services/rest/?method=flickr.photos.search&format=json&nojsoncallback=1&api_key=5587ac217c9b51a9f2c2a48f6bc32e60&tags=cat")!
        ...
        let task = URLSession.shared.dataTask(with: url, completionHandler: {(data, response, error) -> Void in
            ...
            if let jsonUnformatted = try? JSONSerialization.jsonObject(with: data!, options: []) {
                ...
                if let photosArray = photosDictionary?["photo"] as? [[String : AnyObject]] {
                    ...
                    // We use OperationQueue.main because we need to update all UI elements on the main thread.
                    // This is a rule of and you will see this again whenever you are updating UI
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let task = URLSession.shared.downloadTask(with: post.imageURL) { (url, respomse, error) -> Void in
...
//
//            //3. Add Posts to our post array
//            // adds it to the top of our array
